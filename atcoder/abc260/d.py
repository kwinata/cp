...
def main():
	...
	eaten = {card: -1 for card in range(1, n+1)}

	for drawn in p:
		print("drawing", drawn)
		avl.insert(drawn)
		succ = avl.successor(avl.searchTree(drawn))
		print("===")
		avl.inorder()
		print("\n===")
		if succ is None:
			...
			stack = stacks[succ.data]
			stack.append(drawn)
			del stacks[succ.data]
			avl.deleteNode(succ.data)
			stacks[drawn] = stack
		print(stacks)
...
def test_avl():
	...
	bst.insert(19)
	bst.insert(20)
	print(bst.searchTree(20))
	print(bst.searchTree(19))
	print(bst.searchTree(21))
	print(bst.successor(bst.searchTree(19)))
	print(bst.successor(bst.searchTree(20)))
